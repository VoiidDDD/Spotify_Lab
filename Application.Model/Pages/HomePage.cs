...
public class HomePage : ModelBase
{
    ...
    private const string PremiumBtnCSS = "button[data-testid='upgrade-button']";
    ...
    public static ButtonControl PremiumButton => new(Driver.FindElementByCss(PremiumBtnCSS));
